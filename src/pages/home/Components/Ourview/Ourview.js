    ...
    <div style={{ display:'flex',justifyContent:'space-evenly'}} >
        ...
        <div className=' ms-5 p-4 ' >
         ...
         <p style={{color:'#D7D7D7',fontSize:'12px'}}>احصل على خدمات موثوقة للصيانة وإصلاح الأعطال<br></br> من فنيين محترفيين لضمان جودة العمل وسرعة الاستجابة</p>
            ...
            <img style={{marginLeft:'5px'}} src={require('../../../../Images/ourview/image 57.png')} alt=''/>
         </div>
         <div style={{display:'flex'}}>
            <div style={{textAlign:'center'}}>
         <h5 style={{color:'#F8F9FB'}}>الصيانة والتجهيز</h5>
         <p style={{color:'#D7D7D7',fontSize:'12px'}}>احصل على خدمات موثوقة للصيانة وإصلاح الأعطال<br></br> من فنيين محترفيين لضمان جودة العمل وسرعة الاستجابة</p>
            ...
            <img style={{marginLeft:'5px'}}  src={require('../../../../Images/ourview/image 58.png')} alt=''/>
         </div>
         <div style={{display:'flex'}}>
            <div style={{textAlign:'center'}} >
         <h5 style={{color:'#F8F9FB'}}>الصيانة والتجهيز</h5>
         <p style={{color:'#D7D7D7',fontSize:'12px'}}>احصل على خدمات موثوقة للصيانة وإصلاح الأعطال<br></br> من فنيين محترفيين لضمان جودة العمل وسرعة الاستجابة</p>
            ...
            <img style={{marginLeft:'5px'}}  src={require('../../../../Images/ourview/image 59.png')} alt=''/>
         </div>
         </div>
         <div className=' pt-3 '>
